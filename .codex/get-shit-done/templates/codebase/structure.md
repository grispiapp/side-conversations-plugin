...
- Usage: Reference from command with `@/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
