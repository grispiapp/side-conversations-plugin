...
```bash
INIT=$(node "/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/templates/spec.md.
