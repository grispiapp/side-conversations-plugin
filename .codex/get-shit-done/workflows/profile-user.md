...
Key references:
- @/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/USER-PROFILE.md" "/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/AGENTS.md
```
