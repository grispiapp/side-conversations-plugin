...
```
Agent(
  prompt="Read /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/templates/SECURITY.md`
