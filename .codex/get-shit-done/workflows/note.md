...
- **Global scope**: `/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/notes/`)
...
2. Glob `/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/notes/` — works in any directory
