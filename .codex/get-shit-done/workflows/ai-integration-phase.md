...
<required_reading>
@/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/ai-frameworks.md
@/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/agents/gsd-eval-planner.md for instructions.
