...
<required_reading>
@/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/user-story-template.md
@/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/spidr-splitting.md
@/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/references/spidr-splitting.md`. Briefly:
