...
```bash
INIT=$(node "/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
