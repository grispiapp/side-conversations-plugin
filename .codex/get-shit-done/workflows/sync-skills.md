...
INSTALL_JS_GLOBAL="/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/davut/Code/grispiapp/side-conversations-plugin/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
