...
The keys live in `.codex/settings.json` (project) or `/Users/davut/Code/grispiapp/side-conversations-plugin/.codex/settings.json` (global) — **not** in `.planning/config.json`:
